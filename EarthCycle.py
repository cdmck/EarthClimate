...
# deltaT = (14.26860099 - earthTemp[1]) * 1.05 # current minus pre-industrial
# print(deltaT)

# popGrowthRate = 1.5 - 1.5 * (2024 - 1990) / 80 # % per year
# print(popGrowthRate)

# globalPop = 8.1
# print(globalPop)

# prodGrowthRate = (popGrowthRate + 2.2 - (2.2-0.33) * ((2024 - 1) - 2000) / 1000) - 0.001 * deltaT ** 2  # % per year
# print(prodGrowthRate)

# globalProd = 90000 # 10^9 $ per year
# print(globalProd)

# carbonIntensity = carbonIntensityInit * (1 - 0.01833) # tons of carbon emitted per $ globalProd
...
# timePref = 1 / (1 + pureTimePrefFactor) # relative importance of each year
# print(timePref)
